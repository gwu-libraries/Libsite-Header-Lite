...
A minimalist responsive header/footer and stylesheet for GW Libraries' web tools that can be used as a simple page frame or a Bootswatch for Twitter Bootstrap.
